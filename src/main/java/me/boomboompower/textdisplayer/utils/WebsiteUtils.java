    ...
    public void begin() {
        if (!isRunning) {
            ...
            modSettingsChecker = schedule(() -> {
                JsonObject object = new JsonParser().parse(rawWithAgent("https://gist.githubusercontent.com/boomboompower/03cf19715bb0b11173908016c3313349/raw/textdisplayer.json")).getAsJsonObject();
